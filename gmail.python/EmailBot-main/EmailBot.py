...
f = open("C:/Users/Lucas yakuza/Desktop/gmail.python/EmailBot-main/userEmails.txt", "r")
...
def readFile():
    try:
        with open("userEmails.txt", "r") as f:
            data = f.read()
            # Processamento do conteúdo do arquivo
    except FileNotFoundError:
        print("Arquivo 'userEmails.txt' não encontrado. Por favor, crie o arquivo no diretório do script.")
        exit()
